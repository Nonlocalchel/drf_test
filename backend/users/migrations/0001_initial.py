    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('customer', 'Customer'), ('worker', 'Worker')], default='customer', max_length=50)),
            ...
            bases=(services.mixins.models.SelfValidationMixin, services.mixins.models.FieldTrackerMixin, models.Model),
            managers=[
